...
public class PatientModel extends Model {
    ...
    public PatientModel(String filename) {
        super(filename);
        this.patientNames = this.getPatientNames();
    }
    protected void setPatientNames() {
    ...
    //for patient profile
    protected HashMap<String,String> createDict(String patientID) {
